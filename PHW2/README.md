...
You can see the visualization results on .ipynb file run for each four model in 'result' folder.<br>
PHW2.py is the full code that runs four models at once with the function AutoML.
